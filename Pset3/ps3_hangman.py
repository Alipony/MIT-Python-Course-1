...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while guessnum > 0:
        ...
        # takes in the user's guess and converts it in to lower case
        guess = input('Please guess a letter: ').lower()
        # adds guessed letter to letters guessed and clones letters guessed
        oldletters = lettersGuessed[:]
        lettersGuessed.append(guess)

        # responce to input and show progress
        wordSoFar = getGuessedWord(secretWord, lettersGuessed)
        if guess in oldletters:
